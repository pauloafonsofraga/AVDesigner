export class PerfHud {
  constructor(element) {
    ...
    this.rows = [
      ...
      ["placement", () => this.metric("placement")],
      ["placement ids", () => this.metric("placement ids")],
      ["placement dx", () => this.metric("placement dx")],
      ["placement candidates", () => this.metric("placement candidates")],
      ["placement colliding", () => this.metric("placement colliding")],
      ["placement snap", () => this.metric("placement snap")],
      ["placement search", () => this.metric("placement search")],
      ["Project Devices", () => this.metric("Project Devices")],
      ["Project Devices orphan", () => this.metric("Project Devices orphan")],
      ["Project Devices action", () => this.metric("Project Devices action")],
