...
Iteration 40.2 tightens exact Legacy visual parity for cached Engine device
textures. It keeps the Iteration 40 modular-card metadata path, sharpens cached
device textures, removes the stale square geometry layer behind rounded device
textures, restores Legacy dark shell/faceplate colors, draws rounded
hover/selection overlays, and brings adapter/breakout visuals closer to Legacy
with dashed transparent bodies plus internal fan-out wiring.
...
Current visible build label: `Iteration 40.2`.
The app top bar must show one of these labels:

- `Iteration 40.2 — Engine Editor — iteration40-2`
- `Iteration 40.2 — Legacy Editor — iteration40-2`
...
3. Open the explicit engine editor: `index.html?engine=1&v=iteration40-2`.
4. Open the compatibility default-test alias:
   `index.html?engineDefaultTest=1&v=iteration40-2`.
5. Open the legacy editor fallback:
   `index.html?legacy=1&v=iteration40-2`.
6. Open the alternate legacy fallback:
   `index.html?engine=0&v=iteration40-2`.
7. Open the debug loading guard:
   `index.html?engine=1&debugLoad=1&v=iteration40-2`.
8. Open a timed loading guard:
   `index.html?engine=1&loadDelay=1500&v=iteration40-2`.
...
11. Open the explicit Engine drag/drop debug overlay:
   `index.html?engine=1&debugLibraryDrag=1&v=iteration40-2`.
12. Open the Legacy drag/drop debug overlay:
   `index.html?legacy=1&debugLibraryDrag=1&v=iteration40-2`.
13. Open compatibility diagnostics while drawing wires:
    `index.html?engine=1&debugCompatibility=1&v=iteration40-2`.
14. Open routing diagnostics while selecting or editing orthogonal wires:
    `index.html?engine=1&debugHud=1&debugRouting=1&v=iteration40-2`.
15. Open endpoint-rewire diagnostics:
    `index.html?engine=1&debugRewire=1&debugRouting=1&v=iteration40-2`.
...
25. Compare Engine and Legacy connector behavior with the same project:
   `index.html?v=iteration40-2` beside
   `index.html?legacy=1&v=iteration40-2`.
25. In `index.html?engine=1&debugHud=1&v=iteration40-2`, confirm the HUD
...
38. Open `index.html?engine=1&debugHud=1&debugLayers=1&v=iteration40-2`, drag
...
49. Open `index.html?engine=1&debugHud=1&v=iteration40-2` and confirm the HUD
    rows `cable hops`, `cable hop calc`, `cable hop candidates`, and
    `cable hop dirty` update.
50. Open `index.html?engine=1&debugHud=1&debugRouting=1&v=iteration40-2`,
...
60. Repeat a Device Library drag/drop in `index.html?legacy=1&v=iteration40-2`
...
- Confirm the visible top-bar label shows either
  `Iteration 40.2 — Engine Editor — iteration40-2` or
  `Iteration 40.2 — Legacy Editor — iteration40-2`.
...
- Confirm selected/hovered devices use rounded Legacy-style overlays instead of
  square outlines.
