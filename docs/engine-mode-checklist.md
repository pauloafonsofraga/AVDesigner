...
Iteration 40.3 corrects the remaining Engine device visual parity issues from
the comparison screenshots. It keeps cached device textures, sharpens the
texture cache again, moves connector circles and connector labels into live
world-space layers so they are not clipped by texture bounds, uses a soft
texture-backed Legacy-style selection glow instead of hard concentric outlines,
and restores Legacy adapter/breakout classification for templates that use
`objectType: "adapter"`.
...
Current visible build label: `Iteration 40.3`.
The app top bar must show one of these labels:

- `Iteration 40.3 — Engine Editor — iteration40-3`
- `Iteration 40.3 — Legacy Editor — iteration40-3`
...
2. Open the default engine editor with cache busting:
   `index.html?v=iteration40-3`.
3. Open the explicit engine editor: `index.html?engine=1&v=iteration40-3`.
4. Open the compatibility default-test alias:
   `index.html?engineDefaultTest=1&v=iteration40-3`.
5. Open the legacy editor fallback:
   `index.html?legacy=1&v=iteration40-3`.
6. Open the alternate legacy fallback:
   `index.html?engine=0&v=iteration40-3`.
7. Open the debug loading guard:
   `index.html?engine=1&debugLoad=1&v=iteration40-3`.
8. Open a timed loading guard:
   `index.html?engine=1&loadDelay=1500&v=iteration40-3`.
9. Open the expanded engine HUD:
   `index.html?engine=1&debugHud=1&v=iteration40-3`.
9a. Open the device visual diagnostic HUD/layer view:
   `index.html?engine=1&debugDeviceVisual=1&v=iteration40-3`.
10. Open the Device Library drag/drop debug overlay:
   `index.html?debugLibraryDrag=1&v=iteration40-3`.
11. Open the explicit Engine drag/drop debug overlay:
   `index.html?engine=1&debugLibraryDrag=1&v=iteration40-3`.
12. Open the Legacy drag/drop debug overlay:
   `index.html?legacy=1&debugLibraryDrag=1&v=iteration40-3`.
13. Open compatibility diagnostics while drawing wires:
    `index.html?engine=1&debugCompatibility=1&v=iteration40-3`.
14. Open routing diagnostics while selecting or editing orthogonal wires:
    `index.html?engine=1&debugHud=1&debugRouting=1&v=iteration40-3`.
15. Open endpoint-rewire diagnostics:
    `index.html?engine=1&debugRewire=1&debugRouting=1&v=iteration40-3`.
...
25. Compare Engine and Legacy connector behavior with the same project:
   `index.html?v=iteration40-3` beside
   `index.html?legacy=1&v=iteration40-3`.
25. In `index.html?engine=1&debugHud=1&v=iteration40-3`, confirm the HUD
...
38. Open `index.html?engine=1&debugHud=1&debugLayers=1&v=iteration40-3`, drag
...
49. Open `index.html?engine=1&debugHud=1&v=iteration40-3` and confirm the HUD
    rows `cable hops`, `cable hop calc`, `cable hop candidates`, and
    `cable hop dirty` update.
50. Open `index.html?engine=1&debugHud=1&debugRouting=1&v=iteration40-3`,
...
60. Repeat a Device Library drag/drop in `index.html?legacy=1&v=iteration40-3`
