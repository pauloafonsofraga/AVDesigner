...
Iteration 53.2 migrates the Engine-mode Rack Builder preview to the shared
Engine preview surface. Rack Builder remains the production source of truth for
editing rack definitions, internal wiring, exposed ports, and placement, but
committed preview visuals now use the same SceneGraph/WebGL renderer as placed
Engine racks; SVG is reserved for authoring overlays.
