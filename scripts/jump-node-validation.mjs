...
const BUILD_ID = "iteration54-36-9-large-led-surface-safety";
...
assert.ok(indexHtml.includes(`const APP_BUILD_ID = "${BUILD_ID}";`), "app build id should identify Large LED Surface Safety");
assert.ok(indexHtml.includes('const APP_MODULE_CACHE_ID = "iteration54-36-9-large-led-surface-safety-modules";'), "module cache key should identify Large LED Surface Safety");
assert.ok(indexHtml.includes("Large LED Surface Safety"), "visible build label should name Large LED Surface Safety");
