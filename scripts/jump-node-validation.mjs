...
const BUILD_ID = "iteration54-21-1-append-device-editor-nodes";
...
assert.ok(indexHtml.includes(`const APP_BUILD_ID = "${BUILD_ID}";`), "app build id should identify Append Device Editor Nodes");
assert.ok(indexHtml.includes('const APP_MODULE_CACHE_ID = "iteration54-21-1-append-device-editor-nodes-modules";'), "module cache key should identify Append Device Editor Nodes");
assert.ok(indexHtml.includes("Append Device Editor Nodes"), "visible build label should name Append Device Editor Nodes");
