...
assert.ok(indexHtml.includes('const APP_MODULE_CACHE_ID = "iteration54-14-0-modular-placement-release-hardening-modules";'), "module cache key should identify Modular Placement Release Hardening");
assert.ok(indexHtml.includes("Modular Placement Release Hardening"), "visible build label should name Modular Placement Release Hardening");
assert.ok(bridgeSource.includes('ENGINE_BRIDGE_VERSION = "iteration54-14-0-modular-placement-release-hardening"'), "Engine bridge version should identify Modular Placement Release Hardening");
...
assert.ok(bridgeSource.includes("production-bridge-iteration54-14-0-modular-placement-release-hardening"), "bridge fingerprint should identify Modular Placement Release Hardening");
