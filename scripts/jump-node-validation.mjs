...
const BUILD_ID = "iteration54-3-10-editor-preview-wheel-zoom";
...
assert.ok(indexHtml.includes(`const APP_BUILD_ID = "${BUILD_ID}";`), "app build id should identify Editor Preview Wheel Zoom");
assert.ok(indexHtml.includes('const APP_MODULE_CACHE_ID = "iteration54-3-10-editor-preview-wheel-zoom-modules";'), "module cache key should identify Editor Preview Wheel Zoom");
assert.ok(indexHtml.includes("Editor Preview Wheel Zoom"), "visible build label should name Editor Preview Wheel Zoom");
