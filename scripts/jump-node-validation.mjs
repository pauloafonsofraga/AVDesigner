...
assert.ok(indexHtml.includes(`const APP_BUILD_ID = "${BUILD_ID}";`), "app build id should identify Power Distro Palette Drop Fix");
assert.ok(indexHtml.includes('const APP_MODULE_CACHE_ID = "iteration54-20-3-power-distro-palette-drop-modules";'), "module cache key should identify Power Distro Palette Drop Fix");
assert.ok(indexHtml.includes("Power Distro Palette Drop Fix"), "visible build label should name Power Distro Palette Drop Fix");
