...
const BUILD_ID = "iteration54-20-2-editor-node-drag-drop-fixes";
...
assert.ok(indexHtml.includes(`const APP_BUILD_ID = "${BUILD_ID}";`), "app build id should identify Editor Node Drag and Drop Fixes");
assert.ok(indexHtml.includes('const APP_MODULE_CACHE_ID = "iteration54-20-2-editor-node-drag-drop-fixes-modules";'), "module cache key should identify Editor Node Drag and Drop Fixes");
assert.ok(indexHtml.includes("Editor Node Drag and Drop Fixes"), "visible build label should name Editor Node Drag and Drop Fixes");
