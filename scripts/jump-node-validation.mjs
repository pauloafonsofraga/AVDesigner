...
const BUILD_ID = "iteration54-3-9-card-preview-selection-zoom";
...
assert.ok(indexHtml.includes(`const APP_BUILD_ID = "${BUILD_ID}";`), "app build id should identify Device Editor Card Selection & Preview Zoom");
assert.ok(indexHtml.includes('const APP_MODULE_CACHE_ID = "iteration54-3-9-card-preview-selection-zoom-modules";'), "module cache key should identify Device Editor Card Selection & Preview Zoom");
assert.ok(indexHtml.includes("Device Editor Card Selection & Preview Zoom"), "visible build label should name Device Editor Card Selection & Preview Zoom");
