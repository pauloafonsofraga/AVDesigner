...
assert.ok(indexHtml.includes('const APP_MODULE_CACHE_ID = "iteration54-36-4-global-built-in-defaults-modules";'), "module cache key should identify Global Built-In Defaults");
assert.ok(indexHtml.includes("Global Built-In Defaults"), "visible build label should name Global Built-In Defaults");
