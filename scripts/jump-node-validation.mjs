...
assert.ok(indexHtml.includes('const APP_MODULE_CACHE_ID = "iteration54-14-1-device-editor-card-drag-parity-modules";'), "module cache key should identify Device Editor Card Drag Parity");
assert.ok(indexHtml.includes("Device Editor Card Drag Parity"), "visible build label should name Device Editor Card Drag Parity");
