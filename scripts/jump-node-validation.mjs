...
assert.ok(indexHtml.includes('const APP_MODULE_CACHE_ID = "iteration54-3-11-editor-preview-modifier-wheel-zoom-modules";'), "module cache key should identify Editor Preview Modifier Wheel Zoom");
assert.ok(indexHtml.includes("Editor Preview Modifier Wheel Zoom"), "visible build label should name Editor Preview Modifier Wheel Zoom");
