...
const BUILD_ID = "iteration54-3-15-editor-preview-canvas-wheel-modifier";
...
assert.ok(indexHtml.includes(`const APP_BUILD_ID = "${BUILD_ID}";`), "app build id should identify Editor Preview Canvas Wheel Modifier");
assert.ok(indexHtml.includes('const APP_MODULE_CACHE_ID = "iteration54-3-15-editor-preview-canvas-wheel-modifier-modules";'), "module cache key should identify Editor Preview Canvas Wheel Modifier");
assert.ok(indexHtml.includes("Editor Preview Canvas Wheel Modifier"), "visible build label should name Editor Preview Canvas Wheel Modifier");
