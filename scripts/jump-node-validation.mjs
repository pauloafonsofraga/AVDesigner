...
const BUILD_ID = "iteration54-3-12-remove-processor-faceplate-tags";
...
assert.ok(indexHtml.includes(`const APP_BUILD_ID = "${BUILD_ID}";`), "app build id should identify Remove Processor Faceplate Tags");
assert.ok(indexHtml.includes('const APP_MODULE_CACHE_ID = "iteration54-3-12-remove-processor-faceplate-tags-modules";'), "module cache key should identify Remove Processor Faceplate Tags");
assert.ok(indexHtml.includes("Remove Processor Faceplate Tags"), "visible build label should name Remove Processor Faceplate Tags");
