...
const EXPECTED_APP_BUILD_ID = "iteration54-34-0-unified-engine-output-pipeline";
...
assert.ok(indexHtml.includes('const APP_ITERATION = "54.34.0";'), "app iteration should be 54.34.0");
assert.ok(indexHtml.includes(`const APP_BUILD_ID = "${EXPECTED_APP_BUILD_ID}";`), "app build id should match 54.34.0");
assert.ok(indexHtml.includes('const APP_MODULE_CACHE_ID = "iteration54-34-0-unified-engine-output-pipeline-modules";'), "module cache key should match 54.34.0");
...
assert.ok(indexHtml.includes("Unified Engine Output Pipeline"), "app build label should name 54.34.0");
