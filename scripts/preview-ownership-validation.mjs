...
const EXPECTED_APP_BUILD_ID = "iteration54-21-0-power-distro-catalog-parity";
...
assert.ok(indexHtml.includes('const APP_ITERATION = "54.21.0";'), "app iteration should be 54.21.0");
assert.ok(indexHtml.includes(`const APP_BUILD_ID = "${EXPECTED_APP_BUILD_ID}";`), "app build id should match 54.21.0");
assert.ok(indexHtml.includes('const APP_MODULE_CACHE_ID = "iteration54-21-0-power-distro-catalog-parity-modules";'), "module cache key should match 54.21.0");
...
assert.ok(indexHtml.includes("Power Distro Catalog Parity"), "app build label should name 54.21.0");
