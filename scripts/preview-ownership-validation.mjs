...
const EXPECTED_APP_BUILD_ID = "iteration54-3-8-device-editor-compact-controls";
...
assert.ok(indexHtml.includes('const APP_ITERATION = "54.3.8";'), "app iteration should be 54.3.8");
assert.ok(indexHtml.includes(`const APP_BUILD_ID = "${EXPECTED_APP_BUILD_ID}";`), "app build id should match 54.3.8");
assert.ok(indexHtml.includes('const APP_MODULE_CACHE_ID = "iteration54-3-8-device-editor-compact-controls-modules";'), "module cache key should match 54.3.8");
...
assert.ok(indexHtml.includes("Device Editor Compact Controls"), "app build label should name 54.3.8");
