...
const EXPECTED_APP_BUILD_ID = "iteration54-29-0-per-connection-led-surface-ordering";
...
assert.ok(indexHtml.includes('const APP_ITERATION = "54.29.0";'), "app iteration should be 54.29.0");
assert.ok(indexHtml.includes(`const APP_BUILD_ID = "${EXPECTED_APP_BUILD_ID}";`), "app build id should match 54.29.0");
assert.ok(indexHtml.includes('const APP_MODULE_CACHE_ID = "iteration54-29-0-per-connection-led-surface-ordering-modules";'), "module cache key should match 54.29.0");
...
assert.ok(indexHtml.includes("Per-Connection LED Surface Ordering"), "app build label should name 54.29.0");
