...
const EXPECTED_APP_BUILD_ID = "iteration54-26-1-continuous-shared-bus-junction";
...
assert.ok(indexHtml.includes('const APP_ITERATION = "54.26.1";'), "app iteration should be 54.26.1");
assert.ok(indexHtml.includes(`const APP_BUILD_ID = "${EXPECTED_APP_BUILD_ID}";`), "app build id should match 54.26.1");
assert.ok(indexHtml.includes('const APP_MODULE_CACHE_ID = "iteration54-26-1-continuous-shared-bus-junction-modules";'), "module cache key should match 54.26.1");
...
assert.ok(indexHtml.includes("Continuous Shared Bus Junction"), "app build label should name 54.26.1");
