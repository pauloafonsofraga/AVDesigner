...
const EXPECTED_APP_BUILD_ID = "iteration54-8-1-structural-edit-transaction-hardening";
...
assert.ok(indexHtml.includes('const APP_ITERATION = "54.8.1";'), "app iteration should be 54.8.1");
assert.ok(indexHtml.includes(`const APP_BUILD_ID = "${EXPECTED_APP_BUILD_ID}";`), "app build id should match 54.8.1");
assert.ok(indexHtml.includes('const APP_MODULE_CACHE_ID = "iteration54-8-1-structural-edit-transaction-hardening-modules";'), "module cache key should match 54.8.1");
...
assert.ok(indexHtml.includes("Structural Edit Transaction Hardening"), "app build label should name 54.8.1");
