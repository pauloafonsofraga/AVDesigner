...
const EXPECTED_APP_BUILD_ID = "iteration54-27-0-segmented-wire-preview-parity";
...
assert.ok(indexHtml.includes('const APP_ITERATION = "54.27.0";'), "app iteration should be 54.27.0");
assert.ok(indexHtml.includes(`const APP_BUILD_ID = "${EXPECTED_APP_BUILD_ID}";`), "app build id should match 54.27.0");
assert.ok(indexHtml.includes('const APP_MODULE_CACHE_ID = "iteration54-27-0-segmented-wire-preview-parity-modules";'), "module cache key should match 54.27.0");
...
assert.ok(indexHtml.includes("Segmented Wire Preview Parity"), "app build label should name 54.27.0");
