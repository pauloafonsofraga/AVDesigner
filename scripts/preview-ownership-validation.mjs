...
const EXPECTED_APP_BUILD_ID = "iteration54-17-0-single-owner-modular-drag-composition";
...
assert.ok(indexHtml.includes('const APP_ITERATION = "54.17.0";'), "app iteration should be 54.17.0");
assert.ok(indexHtml.includes(`const APP_BUILD_ID = "${EXPECTED_APP_BUILD_ID}";`), "app build id should match 54.17.0");
assert.ok(indexHtml.includes('const APP_MODULE_CACHE_ID = "iteration54-17-0-single-owner-modular-drag-composition-modules";'), "module cache key should match 54.17.0");
...
assert.ok(indexHtml.includes("Single-Owner Modular Drag Composition"), "app build label should name 54.17.0");
