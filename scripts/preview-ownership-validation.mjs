...
const EXPECTED_APP_BUILD_ID = "iteration54-4-0-matrix-routing-internal-routes";
...
assert.ok(indexHtml.includes('const APP_ITERATION = "54.4.0";'), "app iteration should be 54.4.0");
assert.ok(indexHtml.includes(`const APP_BUILD_ID = "${EXPECTED_APP_BUILD_ID}";`), "app build id should match 54.4.0");
assert.ok(indexHtml.includes('const APP_MODULE_CACHE_ID = "iteration54-4-0-matrix-routing-internal-routes-modules";'), "module cache key should match 54.4.0");
...
assert.ok(indexHtml.includes("Matrix Routing Internal Routes"), "app build label should name 54.4.0");
