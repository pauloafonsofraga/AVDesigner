...
const EXPECTED_APP_BUILD_ID = "iteration54-19-0-rigid-modular-card-composition";
...
assert.ok(indexHtml.includes('const APP_ITERATION = "54.19.0";'), "app iteration should be 54.19.0");
assert.ok(indexHtml.includes(`const APP_BUILD_ID = "${EXPECTED_APP_BUILD_ID}";`), "app build id should match 54.19.0");
assert.ok(indexHtml.includes('const APP_MODULE_CACHE_ID = "iteration54-19-0-rigid-modular-card-composition-modules";'), "module cache key should match 54.19.0");
...
assert.ok(indexHtml.includes("Rigid Modular Card Composition"), "app build label should name 54.19.0");
