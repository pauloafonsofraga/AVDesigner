...
const EXPECTED_APP_BUILD_ID = "iteration54-36-0-selectable-projector-lenses";
...
assert.ok(indexHtml.includes('const APP_ITERATION = "54.36.0";'), "app iteration should be 54.36.0");
assert.ok(indexHtml.includes(`const APP_BUILD_ID = "${EXPECTED_APP_BUILD_ID}";`), "app build id should match 54.36.0");
assert.ok(indexHtml.includes('const APP_MODULE_CACHE_ID = "iteration54-36-0-selectable-projector-lenses-modules";'), "module cache key should match 54.36.0");
...
assert.ok(indexHtml.includes("Selectable Projector Lenses"), "app build label should name 54.36.0");
