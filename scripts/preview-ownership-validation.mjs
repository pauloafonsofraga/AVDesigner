...
const EXPECTED_APP_BUILD_ID = "iteration54-18-0-unified-compact-modular-item-drag";
...
assert.ok(indexHtml.includes('const APP_ITERATION = "54.18.0";'), "app iteration should be 54.18.0");
assert.ok(indexHtml.includes(`const APP_BUILD_ID = "${EXPECTED_APP_BUILD_ID}";`), "app build id should match 54.18.0");
assert.ok(indexHtml.includes('const APP_MODULE_CACHE_ID = "iteration54-18-0-unified-compact-modular-item-drag-modules";'), "module cache key should match 54.18.0");
...
assert.ok(indexHtml.includes("Unified Compact Modular Item Drag"), "app build label should name 54.18.0");
