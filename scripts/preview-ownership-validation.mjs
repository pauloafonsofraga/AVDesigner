...
const EXPECTED_APP_BUILD_ID = "iteration54-30-0-engine-output-scene-contract";
...
assert.ok(indexHtml.includes('const APP_ITERATION = "54.30.0";'), "app iteration should be 54.30.0");
assert.ok(indexHtml.includes(`const APP_BUILD_ID = "${EXPECTED_APP_BUILD_ID}";`), "app build id should match 54.30.0");
assert.ok(indexHtml.includes('const APP_MODULE_CACHE_ID = "iteration54-30-0-engine-output-scene-contract-modules";'), "module cache key should match 54.30.0");
...
assert.ok(indexHtml.includes("Engine Output Scene Contract"), "app build label should name 54.30.0");
