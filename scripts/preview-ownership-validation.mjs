...
const EXPECTED_APP_BUILD_ID = "iteration54-2-5-6-playback-zoom-preservation";
...
assert.ok(indexHtml.includes('const APP_ITERATION = "54.2.5.6";'), "app iteration should be 54.2.5.6");
assert.ok(indexHtml.includes(`const APP_BUILD_ID = "${EXPECTED_APP_BUILD_ID}";`), "app build id should match 54.2.5.6");
assert.ok(indexHtml.includes('const APP_MODULE_CACHE_ID = "iteration54-2-5-6-playback-zoom-preservation-modules";'), "module cache key should match 54.2.5.6");
...
assert.ok(indexHtml.includes("Playback Zoom Preservation"), "app build label should name 54.2.5.6");
