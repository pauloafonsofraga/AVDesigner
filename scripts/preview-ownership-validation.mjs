...
const EXPECTED_APP_BUILD_ID = "iteration54-12-0-atomic-faceplate-origin-mutations";
...
assert.ok(indexHtml.includes('const APP_ITERATION = "54.12.0";'), "app iteration should be 54.12.0");
assert.ok(indexHtml.includes(`const APP_BUILD_ID = "${EXPECTED_APP_BUILD_ID}";`), "app build id should match 54.12.0");
assert.ok(indexHtml.includes('const APP_MODULE_CACHE_ID = "iteration54-12-0-atomic-faceplate-origin-mutations-modules";'), "module cache key should match 54.12.0");
...
assert.ok(indexHtml.includes("Atomic Faceplate Origin Mutations"), "app build label should name 54.12.0");
