...
const EXPECTED_APP_BUILD_ID = "iteration54-2-4-jump-legacy-parity-play-wire";
...
assert.ok(indexHtml.includes('const APP_ITERATION = "54.2.4";'), "app iteration should be 54.2.4");
assert.ok(indexHtml.includes(`const APP_BUILD_ID = "${EXPECTED_APP_BUILD_ID}";`), "app build id should match 54.2.4");
assert.ok(indexHtml.includes('const APP_MODULE_CACHE_ID = "iteration54-2-4-jump-legacy-parity-play-wire-modules";'), "module cache key should match 54.2.4");
...
assert.ok(indexHtml.includes("Jump Legacy Parity & Play Wire"), "app build label should name 54.2.4");
