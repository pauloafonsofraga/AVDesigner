...
const EXPECTED_APP_BUILD_ID = "iteration54-35-4-clipboard-image-mime-normalization";
...
assert.ok(indexHtml.includes('const APP_ITERATION = "54.35.4";'), "app iteration should be 54.35.4");
assert.ok(indexHtml.includes(`const APP_BUILD_ID = "${EXPECTED_APP_BUILD_ID}";`), "app build id should match 54.35.4");
assert.ok(indexHtml.includes('const APP_MODULE_CACHE_ID = "iteration54-35-4-clipboard-image-mime-normalization-modules";'), "module cache key should match 54.35.4");
...
assert.ok(indexHtml.includes("Clipboard Image MIME Normalization"), "app build label should name 54.35.4");
