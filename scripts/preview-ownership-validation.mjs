...
const EXPECTED_APP_BUILD_ID = "iteration54-36-13-multi-source-led-processor-wiring";
...
assert.ok(indexHtml.includes('const APP_ITERATION = "54.36.13";'), "app iteration should be 54.36.13");
assert.ok(indexHtml.includes(`const APP_BUILD_ID = "${EXPECTED_APP_BUILD_ID}";`), "app build id should match 54.36.13");
assert.ok(indexHtml.includes('const APP_MODULE_CACHE_ID = "iteration54-36-13-multi-source-led-processor-wiring-modules";'), "module cache key should match 54.36.13");
...
assert.ok(indexHtml.includes("Multi-Source LED Processor Wiring"), "app build label should name 54.36.13");
