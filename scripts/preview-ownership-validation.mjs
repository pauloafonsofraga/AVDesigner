...
const EXPECTED_APP_BUILD_ID = "iteration54-5-1-v2-display-side-placement-parity";
...
assert.ok(indexHtml.includes('const APP_ITERATION = "54.5.1";'), "app iteration should be 54.5.1");
assert.ok(indexHtml.includes(`const APP_BUILD_ID = "${EXPECTED_APP_BUILD_ID}";`), "app build id should match 54.5.1");
assert.ok(indexHtml.includes('const APP_MODULE_CACHE_ID = "iteration54-5-1-v2-display-side-placement-parity-modules";'), "module cache key should match 54.5.1");
...
assert.ok(indexHtml.includes("V2 Display Side Placement Parity"), "app build label should name 54.5.1");
