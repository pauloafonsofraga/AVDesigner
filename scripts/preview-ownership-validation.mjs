...
const EXPECTED_APP_BUILD_ID = "iteration54-26-2-centered-shared-bus-trunk";
...
assert.ok(indexHtml.includes('const APP_ITERATION = "54.26.2";'), "app iteration should be 54.26.2");
assert.ok(indexHtml.includes(`const APP_BUILD_ID = "${EXPECTED_APP_BUILD_ID}";`), "app build id should match 54.26.2");
assert.ok(indexHtml.includes('const APP_MODULE_CACHE_ID = "iteration54-26-2-centered-shared-bus-trunk-modules";'), "module cache key should match 54.26.2");
...
assert.ok(indexHtml.includes("Centered Shared Bus Trunk"), "app build label should name 54.26.2");
