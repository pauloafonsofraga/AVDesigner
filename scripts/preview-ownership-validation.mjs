...
const EXPECTED_APP_BUILD_ID = "iteration54-34-1-output-jump-link-hover";
...
assert.ok(indexHtml.includes('const APP_ITERATION = "54.34.1";'), "app iteration should be 54.34.1");
assert.ok(indexHtml.includes(`const APP_BUILD_ID = "${EXPECTED_APP_BUILD_ID}";`), "app build id should match 54.34.1");
assert.ok(indexHtml.includes('const APP_MODULE_CACHE_ID = "iteration54-34-1-output-jump-link-hover-modules";'), "module cache key should match 54.34.1");
...
assert.ok(indexHtml.includes("Output Jump Link Hover"), "app build label should name 54.34.1");
