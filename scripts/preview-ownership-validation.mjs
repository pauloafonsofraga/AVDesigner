...
const EXPECTED_APP_BUILD_ID = "iteration54-20-4-native-device-editor-palette-drops";
...
assert.ok(indexHtml.includes('const APP_ITERATION = "54.20.4";'), "app iteration should be 54.20.4");
assert.ok(indexHtml.includes(`const APP_BUILD_ID = "${EXPECTED_APP_BUILD_ID}";`), "app build id should match 54.20.4");
assert.ok(indexHtml.includes('const APP_MODULE_CACHE_ID = "iteration54-20-4-native-device-editor-palette-drops-modules";'), "module cache key should match 54.20.4");
...
assert.ok(indexHtml.includes("Native Device Editor Palette Drops"), "app build label should name 54.20.4");
