...
const EXPECTED_APP_BUILD_ID = "iteration54-1-canvas-layout-visual-corrections";
...
assert.ok(indexHtml.includes('const APP_ITERATION = "54.1";'), "app iteration should be 54.1");
assert.ok(indexHtml.includes(`const APP_BUILD_ID = "${EXPECTED_APP_BUILD_ID}";`), "app build id should match 54.1");
assert.ok(indexHtml.includes('const APP_MODULE_CACHE_ID = "iteration54-1-canvas-layout-visual-corrections-modules";'), "module cache key should match 54.1");
...
assert.ok(indexHtml.includes("Canvas Layout Visual Corrections"), "app build label should name 54.1");
