...
const EXPECTED_APP_BUILD_ID = "iteration54-35-0-compact-matrix-crosspoints";
...
assert.ok(indexHtml.includes('const APP_ITERATION = "54.35.0";'), "app iteration should be 54.35.0");
assert.ok(indexHtml.includes(`const APP_BUILD_ID = "${EXPECTED_APP_BUILD_ID}";`), "app build id should match 54.35.0");
assert.ok(indexHtml.includes('const APP_MODULE_CACHE_ID = "iteration54-35-0-compact-matrix-crosspoints-modules";'), "module cache key should match 54.35.0");
...
assert.ok(indexHtml.includes("Compact Matrix Crosspoints"), "app build label should name 54.35.0");
