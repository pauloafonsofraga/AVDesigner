...
const EXPECTED_APP_BUILD_ID = "iteration54-7-0-device-editor-persistent-placement-motion";
...
assert.ok(indexHtml.includes('const APP_ITERATION = "54.7.0";'), "app iteration should be 54.7.0");
assert.ok(indexHtml.includes(`const APP_BUILD_ID = "${EXPECTED_APP_BUILD_ID}";`), "app build id should match 54.7.0");
assert.ok(indexHtml.includes('const APP_MODULE_CACHE_ID = "iteration54-7-0-device-editor-persistent-placement-motion-modules";'), "module cache key should match 54.7.0");
...
assert.ok(indexHtml.includes("Device Editor Persistent Placement Motion"), "app build label should name 54.7.0");
