...
const EXPECTED_APP_BUILD_ID = "iteration54-32-0-engine-html-publish-outputs";
...
assert.ok(indexHtml.includes('const APP_ITERATION = "54.32.0";'), "app iteration should be 54.32.0");
assert.ok(indexHtml.includes(`const APP_BUILD_ID = "${EXPECTED_APP_BUILD_ID}";`), "app build id should match 54.32.0");
assert.ok(indexHtml.includes('const APP_MODULE_CACHE_ID = "iteration54-32-0-engine-html-publish-outputs-modules";'), "module cache key should match 54.32.0");
...
assert.ok(indexHtml.includes("Engine HTML and Publish Outputs"), "app build label should name 54.32.0");
