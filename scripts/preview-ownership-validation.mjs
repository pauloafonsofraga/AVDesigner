...
const EXPECTED_APP_BUILD_ID = "iteration54-26-0-orthogonal-shared-bus-rendering";
...
assert.ok(indexHtml.includes('const APP_ITERATION = "54.26.0";'), "app iteration should be 54.26.0");
assert.ok(indexHtml.includes(`const APP_BUILD_ID = "${EXPECTED_APP_BUILD_ID}";`), "app build id should match 54.26.0");
assert.ok(indexHtml.includes('const APP_MODULE_CACHE_ID = "iteration54-26-0-orthogonal-shared-bus-rendering-modules";'), "module cache key should match 54.26.0");
...
assert.ok(indexHtml.includes("Orthogonal Shared Bus Rendering"), "app build label should name 54.26.0");
