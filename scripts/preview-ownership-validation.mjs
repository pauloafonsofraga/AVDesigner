...
const EXPECTED_APP_BUILD_ID = "iteration54-14-0-modular-placement-release-hardening";
...
assert.ok(indexHtml.includes('const APP_ITERATION = "54.14.0";'), "app iteration should be 54.14.0");
assert.ok(indexHtml.includes(`const APP_BUILD_ID = "${EXPECTED_APP_BUILD_ID}";`), "app build id should match 54.14.0");
assert.ok(indexHtml.includes('const APP_MODULE_CACHE_ID = "iteration54-14-0-modular-placement-release-hardening-modules";'), "module cache key should match 54.14.0");
...
assert.ok(indexHtml.includes("Modular Placement Release Hardening"), "app build label should name 54.14.0");
