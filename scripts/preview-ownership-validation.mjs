...
const EXPECTED_APP_BUILD_ID = "iteration54-25-0-jump-node-hold-to-link-restoration";
...
assert.ok(indexHtml.includes('const APP_ITERATION = "54.25.0";'), "app iteration should be 54.25.0");
assert.ok(indexHtml.includes(`const APP_BUILD_ID = "${EXPECTED_APP_BUILD_ID}";`), "app build id should match 54.25.0");
assert.ok(indexHtml.includes('const APP_MODULE_CACHE_ID = "iteration54-25-0-jump-node-hold-to-link-restoration-modules";'), "module cache key should match 54.25.0");
...
assert.ok(indexHtml.includes("Jump Node Hold-To-Link Restoration"), "app build label should name 54.25.0");
