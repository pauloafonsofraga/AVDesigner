...
const EXPECTED_APP_BUILD_ID = "iteration54-28-1-device-card-identity-labels";
...
assert.ok(indexHtml.includes('const APP_ITERATION = "54.28.1";'), "app iteration should be 54.28.1");
assert.ok(indexHtml.includes(`const APP_BUILD_ID = "${EXPECTED_APP_BUILD_ID}";`), "app build id should match 54.28.1");
assert.ok(indexHtml.includes('const APP_MODULE_CACHE_ID = "iteration54-28-1-device-card-identity-labels-modules";'), "module cache key should match 54.28.1");
...
assert.ok(indexHtml.includes("Device Card Identity Labels"), "app build label should name 54.28.1");
