...
const EXPECTED_APP_BUILD_ID = "iteration54-2-5-7-playback-100-zoom";
...
assert.ok(indexHtml.includes('const APP_ITERATION = "54.2.5.7";'), "app iteration should be 54.2.5.7");
assert.ok(indexHtml.includes(`const APP_BUILD_ID = "${EXPECTED_APP_BUILD_ID}";`), "app build id should match 54.2.5.7");
assert.ok(indexHtml.includes('const APP_MODULE_CACHE_ID = "iteration54-2-5-7-playback-100-zoom-modules";'), "module cache key should match 54.2.5.7");
...
assert.ok(indexHtml.includes("Playback 100% Zoom"), "app build label should name 54.2.5.7");
