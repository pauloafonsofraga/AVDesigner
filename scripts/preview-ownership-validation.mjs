...
const EXPECTED_APP_BUILD_ID = "iteration54-35-1-matrix-crosshair-highlight";
...
assert.ok(indexHtml.includes('const APP_ITERATION = "54.35.1";'), "app iteration should be 54.35.1");
assert.ok(indexHtml.includes(`const APP_BUILD_ID = "${EXPECTED_APP_BUILD_ID}";`), "app build id should match 54.35.1");
assert.ok(indexHtml.includes('const APP_MODULE_CACHE_ID = "iteration54-35-1-matrix-crosshair-highlight-modules";'), "module cache key should match 54.35.1");
...
assert.ok(indexHtml.includes("Matrix Crosshair Highlight"), "app build label should name 54.35.1");
