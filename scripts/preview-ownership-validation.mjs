...
const EXPECTED_APP_BUILD_ID = "iteration54-28-2-paired-device-brand-labels";
...
assert.ok(indexHtml.includes('const APP_ITERATION = "54.28.2";'), "app iteration should be 54.28.2");
assert.ok(indexHtml.includes(`const APP_BUILD_ID = "${EXPECTED_APP_BUILD_ID}";`), "app build id should match 54.28.2");
assert.ok(indexHtml.includes('const APP_MODULE_CACHE_ID = "iteration54-28-2-paired-device-brand-labels-modules";'), "module cache key should match 54.28.2");
...
assert.ok(indexHtml.includes("Paired Device Brand Labels"), "app build label should name 54.28.2");
