...
const EXPECTED_APP_BUILD_ID = "iteration54-36-10-led-preview-assets";
...
assert.ok(indexHtml.includes('const APP_ITERATION = "54.36.10";'), "app iteration should be 54.36.10");
assert.ok(indexHtml.includes(`const APP_BUILD_ID = "${EXPECTED_APP_BUILD_ID}";`), "app build id should match 54.36.10");
assert.ok(indexHtml.includes('const APP_MODULE_CACHE_ID = "iteration54-36-10-led-preview-assets-modules";'), "module cache key should match 54.36.10");
...
assert.ok(indexHtml.includes("LED Preview Assets"), "app build label should name 54.36.10");
