...
const EXPECTED_APP_BUILD_ID = "iteration54-1-1-comment-double-click-editing";
...
assert.ok(indexHtml.includes('const APP_ITERATION = "54.1.1";'), "app iteration should be 54.1.1");
assert.ok(indexHtml.includes(`const APP_BUILD_ID = "${EXPECTED_APP_BUILD_ID}";`), "app build id should match 54.1.1");
assert.ok(indexHtml.includes('const APP_MODULE_CACHE_ID = "iteration54-1-1-comment-double-click-editing-modules";'), "module cache key should match 54.1.1");
...
assert.ok(indexHtml.includes("Comment Editing Fix"), "app build label should name 54.1.1");
