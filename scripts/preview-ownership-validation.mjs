...
const EXPECTED_APP_BUILD_ID = "iteration54-28-0-relationship-metadata-synchronization";
...
assert.ok(indexHtml.includes('const APP_ITERATION = "54.28.0";'), "app iteration should be 54.28.0");
assert.ok(indexHtml.includes(`const APP_BUILD_ID = "${EXPECTED_APP_BUILD_ID}";`), "app build id should match 54.28.0");
assert.ok(indexHtml.includes('const APP_MODULE_CACHE_ID = "iteration54-28-0-relationship-metadata-synchronization-modules";'), "module cache key should match 54.28.0");
...
assert.ok(indexHtml.includes("Relationship Metadata Synchronization"), "app build label should name 54.28.0");
