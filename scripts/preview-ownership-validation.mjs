...
const EXPECTED_APP_BUILD_ID = "iteration54-7-2-atomic-device-editor-group-drag";
...
assert.ok(indexHtml.includes('const APP_ITERATION = "54.7.2";'), "app iteration should be 54.7.2");
assert.ok(indexHtml.includes(`const APP_BUILD_ID = "${EXPECTED_APP_BUILD_ID}";`), "app build id should match 54.7.2");
assert.ok(indexHtml.includes('const APP_MODULE_CACHE_ID = "iteration54-7-2-atomic-device-editor-group-drag-modules";'), "module cache key should match 54.7.2");
...
assert.ok(indexHtml.includes("Atomic Device Editor Group Drag"), "app build label should name 54.7.2");
