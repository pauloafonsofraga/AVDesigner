...
const EXPECTED_APP_BUILD_ID = "iteration54-2-smart-jump-nodes";
...
assert.ok(indexHtml.includes('const APP_ITERATION = "54.2";'), "app iteration should be 54.2");
assert.ok(indexHtml.includes(`const APP_BUILD_ID = "${EXPECTED_APP_BUILD_ID}";`), "app build id should match 54.2");
assert.ok(indexHtml.includes('const APP_MODULE_CACHE_ID = "iteration54-2-smart-jump-nodes-modules";'), "module cache key should match 54.2");
...
assert.ok(indexHtml.includes("Smart Jump Nodes & Signal Portals"), "app build label should name 54.2");
