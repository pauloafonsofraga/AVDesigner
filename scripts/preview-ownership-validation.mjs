...
const EXPECTED_APP_BUILD_ID = "iteration54-21-1-append-device-editor-nodes";
...
assert.ok(indexHtml.includes('const APP_ITERATION = "54.21.1";'), "app iteration should be 54.21.1");
assert.ok(indexHtml.includes(`const APP_BUILD_ID = "${EXPECTED_APP_BUILD_ID}";`), "app build id should match 54.21.1");
assert.ok(indexHtml.includes('const APP_MODULE_CACHE_ID = "iteration54-21-1-append-device-editor-nodes-modules";'), "module cache key should match 54.21.1");
...
assert.ok(indexHtml.includes("Append Device Editor Nodes"), "app build label should name 54.21.1");
