...
const EXPECTED_APP_BUILD_ID = "iteration54-2-5-4-jump-link-side-inspector";
...
assert.ok(indexHtml.includes('const APP_ITERATION = "54.2.5.4";'), "app iteration should be 54.2.5.4");
assert.ok(indexHtml.includes(`const APP_BUILD_ID = "${EXPECTED_APP_BUILD_ID}";`), "app build id should match 54.2.5.4");
assert.ok(indexHtml.includes('const APP_MODULE_CACHE_ID = "iteration54-2-5-4-jump-link-side-inspector-modules";'), "module cache key should match 54.2.5.4");
...
assert.ok(indexHtml.includes("Jump Link Side Inspector"), "app build label should name 54.2.5.4");
