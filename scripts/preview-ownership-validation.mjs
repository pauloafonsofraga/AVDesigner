...
const EXPECTED_APP_BUILD_ID = "iteration54-36-6-imported-library-defaults";
...
assert.ok(indexHtml.includes('const APP_ITERATION = "54.36.6";'), "app iteration should be 54.36.6");
assert.ok(indexHtml.includes(`const APP_BUILD_ID = "${EXPECTED_APP_BUILD_ID}";`), "app build id should match 54.36.6");
assert.ok(indexHtml.includes('const APP_MODULE_CACHE_ID = "iteration54-36-6-imported-library-defaults-modules";'), "module cache key should match 54.36.6");
...
assert.ok(indexHtml.includes("Imported Library Defaults"), "app build label should name 54.36.6");
