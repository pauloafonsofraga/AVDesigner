...
const EXPECTED_APP_BUILD_ID = "iteration54-2-5-jump-interaction-legacy-actions";
...
assert.ok(indexHtml.includes('const APP_ITERATION = "54.2.5";'), "app iteration should be 54.2.5");
assert.ok(indexHtml.includes(`const APP_BUILD_ID = "${EXPECTED_APP_BUILD_ID}";`), "app build id should match 54.2.5");
assert.ok(indexHtml.includes('const APP_MODULE_CACHE_ID = "iteration54-2-5-jump-interaction-legacy-actions-modules";'), "module cache key should match 54.2.5");
...
assert.ok(indexHtml.includes("Jump Interaction & Legacy Actions"), "app build label should name 54.2.5");
