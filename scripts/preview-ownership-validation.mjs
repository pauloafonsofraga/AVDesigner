...
const EXPECTED_APP_BUILD_ID = "iteration54-16-0-continuous-span-aware-card-drag";
...
assert.ok(indexHtml.includes('const APP_ITERATION = "54.16.0";'), "app iteration should be 54.16.0");
assert.ok(indexHtml.includes(`const APP_BUILD_ID = "${EXPECTED_APP_BUILD_ID}";`), "app build id should match 54.16.0");
assert.ok(indexHtml.includes('const APP_MODULE_CACHE_ID = "iteration54-16-0-continuous-span-aware-card-drag-modules";'), "module cache key should match 54.16.0");
...
assert.ok(indexHtml.includes("Continuous Span-Aware Card Drag"), "app build label should name 54.16.0");
