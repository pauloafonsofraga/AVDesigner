...
const EXPECTED_APP_BUILD_ID = "iteration54-5-0-device-editor-shared-placement";
...
assert.ok(indexHtml.includes('const APP_ITERATION = "54.5.0";'), "app iteration should be 54.5.0");
assert.ok(indexHtml.includes(`const APP_BUILD_ID = "${EXPECTED_APP_BUILD_ID}";`), "app build id should match 54.5.0");
assert.ok(indexHtml.includes('const APP_MODULE_CACHE_ID = "iteration54-5-0-device-editor-shared-placement-modules";'), "module cache key should match 54.5.0");
...
assert.ok(indexHtml.includes("Device Editor Shared Placement"), "app build label should name 54.5.0");
