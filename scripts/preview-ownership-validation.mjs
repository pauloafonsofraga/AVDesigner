...
const EXPECTED_APP_BUILD_ID = "iteration54-10-0-atomic-feature-connector-generation";
...
assert.ok(indexHtml.includes('const APP_ITERATION = "54.10.0";'), "app iteration should be 54.10.0");
assert.ok(indexHtml.includes(`const APP_BUILD_ID = "${EXPECTED_APP_BUILD_ID}";`), "app build id should match 54.10.0");
assert.ok(indexHtml.includes('const APP_MODULE_CACHE_ID = "iteration54-10-0-atomic-feature-connector-generation-modules";'), "module cache key should match 54.10.0");
...
assert.ok(indexHtml.includes("Atomic Feature Connector Generation"), "app build label should name 54.10.0");
