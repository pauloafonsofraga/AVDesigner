...
const EXPECTED_APP_BUILD_ID = "iteration54-19-2-installed-card-interaction-fix";
...
assert.ok(indexHtml.includes('const APP_ITERATION = "54.19.2";'), "app iteration should be 54.19.2");
assert.ok(indexHtml.includes(`const APP_BUILD_ID = "${EXPECTED_APP_BUILD_ID}";`), "app build id should match 54.19.2");
assert.ok(indexHtml.includes('const APP_MODULE_CACHE_ID = "iteration54-19-2-installed-card-interaction-fix-modules";'), "module cache key should match 54.19.2");
...
assert.ok(indexHtml.includes("Installed Card Interaction Fix"), "app build label should name 54.19.2");
