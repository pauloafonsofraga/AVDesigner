...
const EXPECTED_APP_BUILD_ID = "iteration54-34-2-interactive-pdf-jump-navigation";
...
assert.ok(indexHtml.includes('const APP_ITERATION = "54.34.2";'), "app iteration should be 54.34.2");
assert.ok(indexHtml.includes(`const APP_BUILD_ID = "${EXPECTED_APP_BUILD_ID}";`), "app build id should match 54.34.2");
assert.ok(indexHtml.includes('const APP_MODULE_CACHE_ID = "iteration54-34-2-interactive-pdf-jump-navigation-modules";'), "module cache key should match 54.34.2");
...
assert.ok(indexHtml.includes("Interactive PDF Jump Navigation"), "app build label should name 54.34.2");
