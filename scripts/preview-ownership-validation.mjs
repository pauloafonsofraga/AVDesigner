...
const EXPECTED_APP_BUILD_ID = "iteration54-1-2-comment-direct-editing";
...
assert.ok(indexHtml.includes('const APP_ITERATION = "54.1.2";'), "app iteration should be 54.1.2");
assert.ok(indexHtml.includes(`const APP_BUILD_ID = "${EXPECTED_APP_BUILD_ID}";`), "app build id should match 54.1.2");
assert.ok(indexHtml.includes('const APP_MODULE_CACHE_ID = "iteration54-1-2-comment-direct-editing-modules";'), "module cache key should match 54.1.2");
...
assert.ok(indexHtml.includes("Comment Direct Editing"), "app build label should name 54.1.2");
