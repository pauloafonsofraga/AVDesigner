...
const EXPECTED_APP_BUILD_ID = "iteration54-7-1-device-editor-card-motion-parity";
...
assert.ok(indexHtml.includes('const APP_ITERATION = "54.7.1";'), "app iteration should be 54.7.1");
assert.ok(indexHtml.includes(`const APP_BUILD_ID = "${EXPECTED_APP_BUILD_ID}";`), "app build id should match 54.7.1");
assert.ok(indexHtml.includes('const APP_MODULE_CACHE_ID = "iteration54-7-1-device-editor-card-motion-parity-modules";'), "module cache key should match 54.7.1");
...
assert.ok(indexHtml.includes("Device Editor Card Motion Parity"), "app build label should name 54.7.1");
