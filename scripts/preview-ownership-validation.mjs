...
const EXPECTED_APP_BUILD_ID = "iteration54-15-0-compact-modular-authoring-insertion";
...
assert.ok(indexHtml.includes('const APP_ITERATION = "54.15.0";'), "app iteration should be 54.15.0");
assert.ok(indexHtml.includes(`const APP_BUILD_ID = "${EXPECTED_APP_BUILD_ID}";`), "app build id should match 54.15.0");
assert.ok(indexHtml.includes('const APP_MODULE_CACHE_ID = "iteration54-15-0-compact-modular-authoring-insertion-modules";'), "module cache key should match 54.15.0");
...
assert.ok(indexHtml.includes("Compact Modular Authoring Insertion"), "app build label should name 54.15.0");
