...
const EXPECTED_APP_BUILD_ID = "iteration54-13-0-transactional-editor-resize-sessions";
...
assert.ok(indexHtml.includes('const APP_ITERATION = "54.13.0";'), "app iteration should be 54.13.0");
assert.ok(indexHtml.includes(`const APP_BUILD_ID = "${EXPECTED_APP_BUILD_ID}";`), "app build id should match 54.13.0");
assert.ok(indexHtml.includes('const APP_MODULE_CACHE_ID = "iteration54-13-0-transactional-editor-resize-sessions-modules";'), "module cache key should match 54.13.0");
...
assert.ok(indexHtml.includes("Transactional Editor Resize Sessions"), "app build label should name 54.13.0");
