...
const EXPECTED_APP_BUILD_ID = "iteration54-6-0-device-editor-stable-drag-sessions";
...
assert.ok(indexHtml.includes('const APP_ITERATION = "54.6.0";'), "app iteration should be 54.6.0");
assert.ok(indexHtml.includes(`const APP_BUILD_ID = "${EXPECTED_APP_BUILD_ID}";`), "app build id should match 54.6.0");
assert.ok(indexHtml.includes('const APP_MODULE_CACHE_ID = "iteration54-6-0-device-editor-stable-drag-sessions-modules";'), "module cache key should match 54.6.0");
...
assert.ok(indexHtml.includes("Device Editor Stable Drag Sessions"), "app build label should name 54.6.0");
