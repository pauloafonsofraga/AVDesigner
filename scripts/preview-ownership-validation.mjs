...
const EXPECTED_APP_BUILD_ID = "iteration54-20-2-editor-node-drag-drop-fixes";
...
assert.ok(indexHtml.includes('const APP_ITERATION = "54.20.2";'), "app iteration should be 54.20.2");
assert.ok(indexHtml.includes(`const APP_BUILD_ID = "${EXPECTED_APP_BUILD_ID}";`), "app build id should match 54.20.2");
assert.ok(indexHtml.includes('const APP_MODULE_CACHE_ID = "iteration54-20-2-editor-node-drag-drop-fixes-modules";'), "module cache key should match 54.20.2");
...
assert.ok(indexHtml.includes("Editor Node Drag and Drop Fixes"), "app build label should name 54.20.2");
