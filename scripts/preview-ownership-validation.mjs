...
const EXPECTED_APP_BUILD_ID = "iteration54-20-3-power-distro-palette-drop";
...
assert.ok(indexHtml.includes('const APP_ITERATION = "54.20.3";'), "app iteration should be 54.20.3");
assert.ok(indexHtml.includes(`const APP_BUILD_ID = "${EXPECTED_APP_BUILD_ID}";`), "app build id should match 54.20.3");
assert.ok(indexHtml.includes('const APP_MODULE_CACHE_ID = "iteration54-20-3-power-distro-palette-drop-modules";'), "module cache key should match 54.20.3");
...
assert.ok(indexHtml.includes("Power Distro Palette Drop Fix"), "app build label should name 54.20.3");
