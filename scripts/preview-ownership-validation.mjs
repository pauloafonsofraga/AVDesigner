...
const EXPECTED_APP_BUILD_ID = "iteration54-8-0-atomic-device-editor-structural-edits";
...
assert.ok(indexHtml.includes('const APP_ITERATION = "54.8.0";'), "app iteration should be 54.8.0");
assert.ok(indexHtml.includes(`const APP_BUILD_ID = "${EXPECTED_APP_BUILD_ID}";`), "app build id should match 54.8.0");
assert.ok(indexHtml.includes('const APP_MODULE_CACHE_ID = "iteration54-8-0-atomic-device-editor-structural-edits-modules";'), "module cache key should match 54.8.0");
...
assert.ok(indexHtml.includes("Atomic Device Editor Structural Edits"), "app build label should name 54.8.0");
