...
const EXPECTED_APP_BUILD_ID = "iteration54-35-2-cross-tab-canvas-clipboard";
...
assert.ok(indexHtml.includes('const APP_ITERATION = "54.35.2";'), "app iteration should be 54.35.2");
assert.ok(indexHtml.includes(`const APP_BUILD_ID = "${EXPECTED_APP_BUILD_ID}";`), "app build id should match 54.35.2");
assert.ok(indexHtml.includes('const APP_MODULE_CACHE_ID = "iteration54-35-2-cross-tab-canvas-clipboard-modules";'), "module cache key should match 54.35.2");
...
assert.ok(indexHtml.includes("Cross-Tab Canvas Clipboard"), "app build label should name 54.35.2");
