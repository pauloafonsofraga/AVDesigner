...
const EXPECTED_APP_BUILD_ID = "iteration54-14-1-device-editor-card-drag-parity";
...
assert.ok(indexHtml.includes('const APP_ITERATION = "54.14.1";'), "app iteration should be 54.14.1");
assert.ok(indexHtml.includes(`const APP_BUILD_ID = "${EXPECTED_APP_BUILD_ID}";`), "app build id should match 54.14.1");
assert.ok(indexHtml.includes('const APP_MODULE_CACHE_ID = "iteration54-14-1-device-editor-card-drag-parity-modules";'), "module cache key should match 54.14.1");
...
assert.ok(indexHtml.includes("Device Editor Card Drag Parity"), "app build label should name 54.14.1");
