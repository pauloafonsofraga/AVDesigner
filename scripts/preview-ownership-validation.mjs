...
const EXPECTED_APP_BUILD_ID = "iteration54-4-4-canvas-device-editor-override-sync";
...
assert.ok(indexHtml.includes('const APP_ITERATION = "54.4.4";'), "app iteration should be 54.4.4");
assert.ok(indexHtml.includes(`const APP_BUILD_ID = "${EXPECTED_APP_BUILD_ID}";`), "app build id should match 54.4.4");
assert.ok(indexHtml.includes('const APP_MODULE_CACHE_ID = "iteration54-4-4-canvas-device-editor-override-sync-modules";'), "module cache key should match 54.4.4");
...
assert.ok(indexHtml.includes("Canvas Device Editor Override Sync"), "app build label should name 54.4.4");
