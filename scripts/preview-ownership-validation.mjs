...
const EXPECTED_APP_BUILD_ID = "iteration54-11-0-atomic-power-distro-origin-rebase";
...
assert.ok(indexHtml.includes('const APP_ITERATION = "54.11.0";'), "app iteration should be 54.11.0");
assert.ok(indexHtml.includes(`const APP_BUILD_ID = "${EXPECTED_APP_BUILD_ID}";`), "app build id should match 54.11.0");
assert.ok(indexHtml.includes('const APP_MODULE_CACHE_ID = "iteration54-11-0-atomic-power-distro-origin-rebase-modules";'), "module cache key should match 54.11.0");
...
assert.ok(indexHtml.includes("Atomic Power Distro Origin Rebase"), "app build label should name 54.11.0");
