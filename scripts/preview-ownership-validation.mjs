...
const EXPECTED_APP_BUILD_ID = "iteration54-10-1-generated-connector-selection-hardening";
...
assert.ok(indexHtml.includes('const APP_ITERATION = "54.10.1";'), "app iteration should be 54.10.1");
assert.ok(indexHtml.includes(`const APP_BUILD_ID = "${EXPECTED_APP_BUILD_ID}";`), "app build id should match 54.10.1");
assert.ok(indexHtml.includes('const APP_MODULE_CACHE_ID = "iteration54-10-1-generated-connector-selection-hardening-modules";'), "module cache key should match 54.10.1");
...
assert.ok(indexHtml.includes("Generated Connector Selection Hardening"), "app build label should name 54.10.1");
