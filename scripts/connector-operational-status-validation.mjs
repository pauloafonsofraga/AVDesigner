...
assert.ok(bridgeSource.includes('ENGINE_BRIDGE_VERSION = "iteration54-8-0-atomic-device-editor-structural-edits"'), "bridge version should identify Atomic Device Editor Structural Edits");
