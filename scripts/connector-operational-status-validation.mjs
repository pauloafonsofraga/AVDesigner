...
assert.ok(bridgeSource.includes('ENGINE_BRIDGE_VERSION = "iteration54-8-1-structural-edit-transaction-hardening"'), "bridge version should identify Structural Edit Transaction Hardening");
