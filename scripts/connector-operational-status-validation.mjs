...
assert.ok(bridgeSource.includes('ENGINE_BRIDGE_VERSION = "iteration54-4-3-canvas-connector-fields"'), "bridge version should identify Canvas Connector Inspector Fields");
