...
assert.ok(indexHtml.includes('const APP_MODULE_CACHE_ID = "iteration54-31-0-read-only-engine-output-viewer-modules";'), "module cache key should bust 54.31.0 modules");
