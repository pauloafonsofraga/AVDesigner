...
assert.ok(indexHtml.includes('const APP_MODULE_CACHE_ID = "iteration54-5-1-v2-display-side-placement-parity-modules";'), "module cache key should bust 54.5.1 modules");
assert.ok(bridgeSource.includes('ENGINE_BRIDGE_VERSION = "iteration54-5-1-v2-display-side-placement-parity"'), "bridge version should identify V2 Display Side Placement Parity");
