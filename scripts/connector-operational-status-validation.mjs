...
assert.ok(bridgeSource.includes('ENGINE_BRIDGE_VERSION = "iteration54-4-0-matrix-routing-internal-routes"'), "bridge version should identify Matrix Routing Internal Routes");
