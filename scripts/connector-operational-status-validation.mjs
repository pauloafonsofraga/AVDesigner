...
assert.ok(bridgeSource.includes('ENGINE_BRIDGE_VERSION = "iteration54-9-0-atomic-card-definition-fan-out"'), "bridge version should identify Atomic Card Definition Fan-Out");
