...
assert.ok(bridgeSource.includes('ENGINE_BRIDGE_VERSION = "iteration54-4-4-canvas-device-editor-override-sync"'), "bridge version should identify Canvas Device Editor Override Sync");
