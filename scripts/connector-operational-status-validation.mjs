...
assert.ok(indexHtml.includes('const APP_MODULE_CACHE_ID = "iteration54-30-0-engine-output-scene-contract-modules";'), "module cache key should bust 54.30.0 modules");
