...
assert.ok(bridgeSource.includes('ENGINE_BRIDGE_VERSION = "iteration54-6-0-device-editor-stable-drag-sessions"'), "bridge version should identify Device Editor Stable Drag Sessions");
