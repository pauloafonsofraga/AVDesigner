...
assert.ok(bridgeSource.includes('ENGINE_BRIDGE_VERSION = "iteration54-7-0-device-editor-persistent-placement-motion"'), "bridge version should identify Device Editor Persistent Placement Motion");
