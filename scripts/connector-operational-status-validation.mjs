...
assert.ok(bridgeSource.includes('ENGINE_BRIDGE_VERSION = "iteration54-9-1-card-fan-out-edge-hardening"'), "bridge version should identify Card Fan-Out Edge Hardening");
