...
assert.ok(bridgeSource.includes('ENGINE_BRIDGE_VERSION = "iteration54-5-0-device-editor-shared-placement"'), "bridge version should identify Device Editor Shared Placement");
