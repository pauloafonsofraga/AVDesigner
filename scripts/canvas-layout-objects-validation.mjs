...
assert.ok(indexHtml.includes(`const APP_BUILD_ID = "${BUILD_ID}";`), "app build id should identify Iteration 54.18.0");
assert.ok(indexHtml.includes('const APP_ITERATION = "54.18.0";'), "visible iteration should be 54.18.0");
assert.ok(indexHtml.includes('const APP_MODULE_CACHE_ID = "iteration54-18-0-unified-compact-modular-item-drag-modules";'), "module cache key should bust 54.18.0 modules");
