...
assert.ok(indexHtml.includes(`const APP_BUILD_ID = "${BUILD_ID}";`), "app build id should identify Iteration 54.35.3");
assert.ok(indexHtml.includes('const APP_ITERATION = "54.35.3";'), "visible iteration should be 54.35.3");
assert.ok(indexHtml.includes('const APP_MODULE_CACHE_ID = "iteration54-35-3-asset-safe-cross-tab-clipboard-modules";'), "module cache key should bust 54.35.3 modules");
