...
assert.ok(indexHtml.includes(`const APP_BUILD_ID = "${BUILD_ID}";`), "app build id should identify Iteration 54.11.0");
assert.ok(indexHtml.includes('const APP_ITERATION = "54.11.0";'), "visible iteration should be 54.11.0");
...
assert.ok(bridgeSource.includes('ENGINE_BRIDGE_VERSION = "iteration54-11-0-atomic-power-distro-origin-rebase"'), "Engine bridge version should identify Iteration 54.11.0");
