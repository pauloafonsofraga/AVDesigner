...
assert.ok(indexHtml.includes(`const APP_BUILD_ID = "${BUILD_ID}";`), "app build id should identify Iteration 54.3.13");
assert.ok(indexHtml.includes('const APP_ITERATION = "54.3.13";'), "visible iteration should be 54.3.13");
assert.ok(indexHtml.includes('const APP_MODULE_CACHE_ID = "iteration54-3-13-swappable-card-pcb-icon-modules";'), "module cache key should bust 54.3.13 modules");
