...
assert.ok(indexHtml.includes(`const APP_BUILD_ID = "${BUILD_ID}";`), "app build id should identify Iteration 54.24.0");
assert.ok(indexHtml.includes('const APP_ITERATION = "54.24.0";'), "visible iteration should be 54.24.0");
assert.ok(indexHtml.includes('const APP_MODULE_CACHE_ID = "iteration54-24-0-modular-placement-integration-hardening-modules";'), "module cache key should bust 54.24.0 modules");
