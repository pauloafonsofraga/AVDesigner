...
assert.ok(indexHtml.includes(`const APP_BUILD_ID = "${BUILD_ID}";`), "app build id should identify Iteration 54.3.15");
assert.ok(indexHtml.includes('const APP_ITERATION = "54.3.15";'), "visible iteration should be 54.3.15");
assert.ok(indexHtml.includes('const APP_MODULE_CACHE_ID = "iteration54-3-15-editor-preview-canvas-wheel-modifier-modules";'), "module cache key should bust 54.3.15 modules");
