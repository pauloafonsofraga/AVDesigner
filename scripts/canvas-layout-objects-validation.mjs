...
assert.ok(indexHtml.includes(`const APP_BUILD_ID = "${BUILD_ID}";`), "app build id should identify Iteration 54.3.8");
assert.ok(indexHtml.includes('const APP_ITERATION = "54.3.8";'), "visible iteration should be 54.3.8");
assert.ok(indexHtml.includes('const APP_MODULE_CACHE_ID = "iteration54-3-8-device-editor-compact-controls-modules";'), "module cache key should bust 54.3.8 modules");
