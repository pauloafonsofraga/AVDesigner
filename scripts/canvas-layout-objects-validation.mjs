...
assert.ok(indexHtml.includes(`const APP_BUILD_ID = "${BUILD_ID}";`), "app build id should identify Iteration 54.34.2");
assert.ok(indexHtml.includes('const APP_ITERATION = "54.34.2";'), "visible iteration should be 54.34.2");
assert.ok(indexHtml.includes('const APP_MODULE_CACHE_ID = "iteration54-34-2-interactive-pdf-jump-navigation-modules";'), "module cache key should bust 54.34.2 modules");
