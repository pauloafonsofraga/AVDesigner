...
assert.ok(indexHtml.includes(`const APP_BUILD_ID = "${BUILD_ID}";`), "app build id should identify Iteration 54.29.0");
assert.ok(indexHtml.includes('const APP_ITERATION = "54.29.0";'), "visible iteration should be 54.29.0");
