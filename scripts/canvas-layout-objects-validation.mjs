...
assert.ok(indexHtml.includes(`const APP_BUILD_ID = "${BUILD_ID}";`), "app build id should identify Iteration 54.31.1");
assert.ok(indexHtml.includes('const APP_ITERATION = "54.31.1";'), "visible iteration should be 54.31.1");
assert.ok(indexHtml.includes('const APP_MODULE_CACHE_ID = "iteration54-31-1-bidirectional-jump-node-support-modules";'), "module cache key should bust 54.31.1 modules");
