...
assert.ok(indexHtml.includes(`const APP_BUILD_ID = "${BUILD_ID}";`), "app build id should identify Iteration 54.36.4");
assert.ok(indexHtml.includes('const APP_ITERATION = "54.36.4";'), "visible iteration should be 54.36.4");
