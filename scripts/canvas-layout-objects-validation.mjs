...
assert.ok(indexHtml.includes(`const APP_BUILD_ID = "${BUILD_ID}";`), "app build id should identify Iteration 54.7.0");
assert.ok(indexHtml.includes('const APP_ITERATION = "54.7.0";'), "visible iteration should be 54.7.0");
assert.ok(indexHtml.includes('const APP_MODULE_CACHE_ID = "iteration54-7-0-device-editor-persistent-placement-motion-modules";'), "module cache key should bust 54.7.0 modules");
assert.ok(bridgeSource.includes('ENGINE_BRIDGE_VERSION = "iteration54-7-0-device-editor-persistent-placement-motion"'), "Engine bridge version should identify Iteration 54.7.0");
