...
assert.ok(indexHtml.includes(`const APP_BUILD_ID = "${BUILD_ID}";`), "app build id should identify Iteration 54.35.4");
assert.ok(indexHtml.includes('const APP_ITERATION = "54.35.4";'), "visible iteration should be 54.35.4");
assert.ok(indexHtml.includes('const APP_MODULE_CACHE_ID = "iteration54-35-4-clipboard-image-mime-normalization-modules";'), "module cache key should bust 54.35.4 modules");
