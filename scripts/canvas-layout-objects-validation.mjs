...
assert.ok(indexHtml.includes(`const APP_BUILD_ID = "${BUILD_ID}";`), "app build id should identify Iteration 54.36.12");
assert.ok(indexHtml.includes('const APP_ITERATION = "54.36.12";'), "visible iteration should be 54.36.12");
