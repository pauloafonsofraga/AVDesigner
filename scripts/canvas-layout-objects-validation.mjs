...
assert.ok(indexHtml.includes(`const APP_BUILD_ID = "${BUILD_ID}";`), "app build id should identify Iteration 54.5.0");
assert.ok(indexHtml.includes('const APP_ITERATION = "54.5.0";'), "visible iteration should be 54.5.0");
assert.ok(indexHtml.includes('const APP_MODULE_CACHE_ID = "iteration54-5-0-device-editor-shared-placement-modules";'), "module cache key should bust 54.5.0 modules");
assert.ok(bridgeSource.includes('ENGINE_BRIDGE_VERSION = "iteration54-5-0-device-editor-shared-placement"'), "Engine bridge version should identify Iteration 54.5.0");
