...
assert.ok(indexHtml.includes(`const APP_BUILD_ID = "${BUILD_ID}";`), "app build id should identify Iteration 54.14.1");
assert.ok(indexHtml.includes('const APP_ITERATION = "54.14.1";'), "visible iteration should be 54.14.1");
...
assert.ok(bridgeSource.includes('ENGINE_BRIDGE_VERSION = "iteration54-14-1-device-editor-card-drag-parity"'), "Engine bridge version should identify Iteration 54.14.1");
