...
assert.ok(indexHtml.includes(`const APP_BUILD_ID = "${BUILD_ID}";`), "app build id should identify Iteration 54.35.2");
assert.ok(indexHtml.includes('const APP_ITERATION = "54.35.2";'), "visible iteration should be 54.35.2");
assert.ok(indexHtml.includes('const APP_MODULE_CACHE_ID = "iteration54-35-2-cross-tab-canvas-clipboard-modules";'), "module cache key should bust 54.35.2 modules");
