...
assert.ok(indexHtml.includes(`const APP_BUILD_ID = "${BUILD_ID}";`), "app build id should identify Iteration 54.6.0");
assert.ok(indexHtml.includes('const APP_ITERATION = "54.6.0";'), "visible iteration should be 54.6.0");
assert.ok(indexHtml.includes('const APP_MODULE_CACHE_ID = "iteration54-6-0-device-editor-stable-drag-sessions-modules";'), "module cache key should bust 54.6.0 modules");
assert.ok(bridgeSource.includes('ENGINE_BRIDGE_VERSION = "iteration54-6-0-device-editor-stable-drag-sessions"'), "Engine bridge version should identify Iteration 54.6.0");
