...
assert.ok(indexHtml.includes(`const APP_BUILD_ID = "${BUILD_ID}";`), "app build id should identify Iteration 54.15.0");
assert.ok(indexHtml.includes('const APP_ITERATION = "54.15.0";'), "visible iteration should be 54.15.0");
assert.ok(indexHtml.includes('const APP_MODULE_CACHE_ID = "iteration54-15-0-compact-modular-authoring-insertion-modules";'), "module cache key should bust 54.15.0 modules");
