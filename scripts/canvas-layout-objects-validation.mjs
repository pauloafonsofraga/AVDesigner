...
assert.ok(indexHtml.includes(`const APP_BUILD_ID = "${BUILD_ID}";`), "app build id should identify Iteration 54.28.1");
assert.ok(indexHtml.includes('const APP_ITERATION = "54.28.1";'), "visible iteration should be 54.28.1");
