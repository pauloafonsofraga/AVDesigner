...
assert.ok(indexHtml.includes(`const APP_BUILD_ID = "${BUILD_ID}";`), "app build id should identify Iteration 54.3.2");
assert.ok(indexHtml.includes('const APP_ITERATION = "54.3.2";'), "visible iteration should be 54.3.2");
...
assert.ok(bridgeSource.includes(`ENGINE_BRIDGE_VERSION = "${BUILD_ID}"`), "Engine bridge version should identify Iteration 54.3.2");
