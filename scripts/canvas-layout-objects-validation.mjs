...
assert.ok(indexHtml.includes(`const APP_BUILD_ID = "${BUILD_ID}";`), "app build id should identify Iteration 54.21.0");
assert.ok(indexHtml.includes('const APP_ITERATION = "54.21.0";'), "visible iteration should be 54.21.0");
assert.ok(indexHtml.includes('const APP_MODULE_CACHE_ID = "iteration54-21-0-power-distro-catalog-parity-modules";'), "module cache key should bust 54.21.0 modules");
