...
assert.ok(indexHtml.includes(`const APP_BUILD_ID = "${BUILD_ID}";`), "app build id should identify Iteration 54.21.1");
assert.ok(indexHtml.includes('const APP_ITERATION = "54.21.1";'), "visible iteration should be 54.21.1");
assert.ok(indexHtml.includes('const APP_MODULE_CACHE_ID = "iteration54-21-1-append-device-editor-nodes-modules";'), "module cache key should bust 54.21.1 modules");
